...
export const LowerVolumeWhileRecordingToggle: React.FC<
  LowerVolumeWhileRecordingToggleProps
> = React.memo(({ descriptionMode = "tooltip", grouped = false }) => {
  const { getSetting, updateSetting, isUpdating } = useSettings();

  const lowerVolumeEnabled = getSetting("lower_volume_while_recording") ?? false;
